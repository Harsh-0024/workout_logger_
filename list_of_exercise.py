...
list_of_exercises = [
    'Peck Deck Fly', 'Calf Raises Sitting', 'Lat Pulldown', 'Forearm Roller',
    'Incline Dumbbell Press', 'Crunches B', 'Machine Lateral Raise',
    'Forearm Radial Deviation', 'Deadlift', 'Calf Raises Standing',
    'Stationary Lunges', 'Wrist Extension - Dumbbell', 'Lower Abs',
    'Barbell Curl', 'Hip Thrust', 'Leg Extension', 'Flat Barbell Press',
    'Neutral-Grip Pull-Ups', 'Romanian Deadlift', 'Walking Dumbbell Lunges',
    'Reverse Curls', 'V Tucks', 'Neutral-Grip Lat Pulldown', 'Lower Chest - Cable',
    'Rear Delt Machine Fly', 'Machine Shoulder Press', 'Hammer Rope Curl',
    'Flat Dumbbell Press', 'Rope Face Pull', 'Triceps Overhead Extension',
    'Incline Barbell Press', 'Crunches A', 'Wrist Flexion - Machine', 'Superman',
    'Dips', 'Wide-Grip Seated Row', 'Hyper Extension', 'Barbell Overhead Press',
    'Triceps Rope', 'Wrist Flexion - Dumbbell', 'Smith Machine Squat',
    'Hip Abduction', 'Lat Dumbbell Rows', 'Pull Ups', 'Hammer Dumbbell Curl',
    'Cable Lateral Raise', 'Triceps Rod', 'Neutral-Grip Seated Row', 'Preacher Curl',
    'Forearm Ulnar Deviation', 'Leg Curl', 'Dumbbell Curl',
    'Dumbbell Overhead Press', 'Leg Press', 'Farmer Walk',
    'Wrist Extension - Machine', 'Machine Squat', 'Hip Adduction'
]
